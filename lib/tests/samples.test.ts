        ...
        expect(
          ...
          \`,
                  ...
                  parameters: [
                      ...
                      },
                      {
                          name: "limit",
                          type: "Query",
                          schema: z.number().int().describe("maximum number of results to return").optional(),
                      },
                  ],
                  ...
                  parameters: [
                      {
                          name: "id",
                          type: "Path",
                          schema: z.number().int().describe("ID of pet to fetch"),
                      },
                  ],
                  response: Pet,
              },
                  ...
                  parameters: [
                      {
                          name: "id",
                          type: "Path",
                          schema: z.number().int().describe("ID of pet to delete"),
                      },
                  ],
                  response: z.void(),
              },
                  ...
                  parameters: [
                      {
                          name: "limit",
                          type: "Query",
                          schema: z.number().int().describe("How many items to return at one time (max 100)").optional(),
                      },
                  ],
                  response: z.array(Pet),
              },
                  ...
                  parameters: [
                      {
                          name: "petId",
                          type: "Path",
                          schema: z.string().describe("The id of the pet to retrieve"),
                      },
                  ],
                  response: Pet,
              },
          ...
          const dataSetList = z
              .object({
                  ...
                  apis: z.array(
                      z
                          .object({
                              apiKey: z.string().describe("To be used as a dataset parameter value"),
                              apiVersionNumber: z.string().describe("To be used as a version parameter value"),
                              apiUrl: z.string().describe("The URL describing the dataset's fields"),
                              apiDocumentationUrl: z.string().describe("A URL to the API console for each API"),
                          })
                          .partial()
                  ),
              })
          ...
          const perform_search_Body = z.object({
              criteria: z
                  ...
                  .default("*:*"),
              start: z.number().int().describe("Starting record number. Default value is 0.").optional(),
              rows: z
                  .number()
                  .int()
                  .describe(
                  ...
                  parameters: [
                      {
                          name: "dataset",
                          type: "Path",
                          schema: z.string().describe("Name of the dataset."),
                      },
                      {
                          name: "version",
                          type: "Path",
                          schema: z.string().describe("Version of the dataset."),
                      },
                  ],
                  response: z.string(),
                  errors: [
              ...
              },
              {
                  ...
                  parameters: [
                      ...
                      },
                      {
                          name: "version",
                          type: "Path",
                          schema: z.string().describe("Version of the dataset.").default("v1"),
                      },
                      {
                          name: "dataset",
                          type: "Path",
                          schema: z
                              .string()
                              .describe("Name of the dataset. In this case, the default value is oa_citations")
