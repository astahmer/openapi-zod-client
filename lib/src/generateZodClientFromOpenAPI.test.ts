    ...
    expect(result).toMatchInlineSnapshot(`
      {
          ...
          "schemas": {
              ...
              "Pet": "z.object({ id: z.number().int().optional(), name: z.string(), category: Category.optional(), photoUrls: z.array(z.string()).readonly(), tags: z.array(Tag).readonly().optional(), status: z.enum(["available", "pending", "sold"]).optional() }).readonly().passthrough()",
